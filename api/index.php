...
switch (strtoupper($url[0])) {
  ...
  case 'FUNCIONAMENTOS':
    require_once('funcionamentoAPI/index.php');
    break;

  case 'EMAILESTACIONAMENTO':
    require_once('emailEstacionamentoAPI/index.php');
    break;

  case 'TELEFONEESTACIONAMENTO':
    require_once('telefoneEstacionamentoAPI/index.php');
    break;
}
